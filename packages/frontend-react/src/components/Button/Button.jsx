...
export default React.memo(function Button({ type, btn, size, style, text, icon, handleClick, href, disabled, w = 97, h = 32, color = 'blue', classNamePrefix = 'button', customColor, isLoading = false }) {
    if (href) {
        return (
            <Link to={href}
